...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-green-400 font-mono p-8 selection:bg-green-900 selection:text-white">
      <header className="max-w-6xl mx-auto border-b-4 border-green-700 pb-6 mb-8 flex flex-col md:flex-row justify-between items-end">
        <div>
          <h1 className="text-5xl font-black mb-2 tracking-tighter">ARBOR <span className="text-white">ARCADE</span></h1>
          <p className="text-sm opacity-80">System Ready. Mode: HTML/JS Injection.</p>
        </div>
      ...
      <main className="max-w-6xl mx-auto">
        ...
        {/* INSTRUCTION CARD */}
        <div className="mb-12 bg-neutral-800/50 p-6 rounded-lg border border-neutral-700 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm mt-1">
              ...
              <span className="text-green-300">"Crea un juego sobre [Tema] en la carpeta [nombre_carpeta]"</span>.<br/>
