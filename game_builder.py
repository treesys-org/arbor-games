...
def main():
    ...
    games_dir = os.path.join(script_dir, "arbor-games")
    ...
    if not os.path.exists(games_dir):
        ...
        print(f"   Ensure 'arbor-games' folder is next to this script.")
        return
    ...
    for item in items:
        ...
        if os.path.isdir(full_path):
            ...
            if os.path.exists(index_file):
                ...
                games.append({
                    ...
                    "icon": meta.get("icon", "👾"),
                    "path": f"./arbor-games/{item}/index.html", # Relative to manifest.json
        ...
        # TYPE B: Standalone HTML File (e.g. juego3.html)
            ...
            games.append({
                "id": clean_id,
                "name": f"Arbor Arcade: {name}",
                "description": "Standalone game module.",
                "icon": "🕹️",
                "path": f"./arbor-games/{item}", # Relative to manifest.json
                "version": "1.0.0",
                "author": "Community"
            })
    ...
    if games:
        ...
        print("\n⚠️  No games found. Manifest was not updated.")
