...
/**
 * CORE.JS
 * Infrastructure: Config, Audio, Input, and Graphics.
 */
...
export const Themes = {
    // 1. CORPORATE: Cool blues, slate, clean (Bank/Law/Gov)
    corporate: {
        bg: '#020617', text: '#22d3ee', hero: '#3b82f6',
        wall: '#334155', floor: '#1e293b', floor_cafe: '#4a044e',
        desk: '#b45309', machine: '#94a3b8', plant: '#22c55e',
        phone_bg: '#1e293b', phone_screen: '#0f172a'
    },
    // 2. LAB: Sterile, white, cyan, research (Science/Medical)
    lab: {
        bg: '#0f172a', text: '#38bdf8', hero: '#f8fafc', // White coat
        wall: '#cbd5e1', floor: '#475569', floor_cafe: '#64748b', 
        desk: '#e2e8f0', // White desks
        machine: '#94a3b8', plant: '#4ade80',
        phone_bg: '#1e293b', phone_screen: '#0f172a'
    },
    // 3. STUDIO: Warm, wood, orange, cozy (Design/Art/Writing)
    studio: {
        bg: '#292524', text: '#fdba74', hero: '#fb923c',
        wall: '#78350f', floor: '#44403c', floor_cafe: '#57534e',
        desk: '#d97706', machine: '#a8a29e', plant: '#84cc16',
        phone_bg: '#451a03', phone_screen: '#292524'
    },
    // 4. INDUSTRIAL: Green, rust, concrete, hazard (Engineering/Factory/Science)
    industrial: {
        bg: '#042f2e', text: '#4ade80', hero: '#2dd4bf',
        wall: '#134e4a', floor: '#064e3b', floor_cafe: '#14532d',
        desk: '#65a30d', machine: '#71717a', plant: '#bef264',
        phone_bg: '#115e59', phone_screen: '#042f2e'
    }
};

export function setTheme(themeName) {
    const t = Themes[themeName] || Themes.corporate;
    // Mutate the exported Palette object so all references update
...
export class Input {
    ...
    onKey(e, isDown) {
        // Prevent input if typing in a text field
...
export class SpriteGen {
    ...
    static get tiles() {
        ...
        ctx.fillStyle = Palette.bg; ctx.fillRect(16, 0, 16, 2); ctx.fillRect(16, 14, 16, 2);
        ...
        // 3: Stairs UP
        ctx.fillStyle = Palette.wall; ctx.fillRect(48,0,16,16);
        for(let i=0;i<4;i++) { ctx.fillStyle=Palette.floor; ctx.fillRect(48, i*4, 16, 1); }
        ctx.fillStyle='#fff'; ctx.font='8px monospace'; ctx.fillText('^', 52, 10);

        // 4: Stairs DOWN
        ctx.fillStyle = Palette.wall; ctx.fillRect(64,0,16,16);
        ...
        // 6: Floor Cafeteria
        ctx.fillStyle = Palette.floor_cafe; ctx.fillRect(96, 0, 16, 16);
        ctx.fillStyle = 'rgba(255,255,255,0.1)'; ctx.fillRect(96,0,8,8); ctx.fillRect(104,8,8,8);

        // 7: NPC Marker (Logic only)

        // 8: Food Counter
        ctx.fillStyle = Palette.floor_cafe; ctx.fillRect(128,0,16,16);
        ctx.fillStyle = Palette.machine; ctx.fillRect(128, 4, 16, 12);
        ...
        // 11: Cafe Table
        ctx.fillStyle = Palette.floor_cafe; ctx.fillRect(176, 0, 16, 16);
